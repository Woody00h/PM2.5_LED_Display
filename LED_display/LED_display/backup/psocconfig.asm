...
export LoadConfig_led_display
export _LoadConfig_led_display
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_led_display
	lcall	LoadConfigTBL_led_display_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration led_display
;
;    Load configuration registers for led_display.
...
;               CUR_PP
;
_LoadConfig_led_display:
 LoadConfig_led_display:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_led_display_Bank0
    mov     X, <LoadConfigTBL_led_display_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_led_display_Bank1
    mov     X, <LoadConfigTBL_led_display_Bank1
