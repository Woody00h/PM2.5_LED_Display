...
#define Timer8_PERIOD                          ( 0x9f )
#define Timer8_COMPARE_VALUE                   ( 0x50 )
...
#pragma ioport  Timer8_COUNTER_REG: 0x030                  //DR0 Count register
BYTE            Timer8_COUNTER_REG;
#pragma ioport  Timer8_PERIOD_REG:  0x031                  //DR1 Period register
BYTE            Timer8_PERIOD_REG;
#pragma ioport  Timer8_COMPARE_REG: 0x032                  //DR2 Compare register
BYTE            Timer8_COMPARE_REG;
#pragma ioport  Timer8_CONTROL_REG: 0x033                  //Control register
BYTE            Timer8_CONTROL_REG;
#pragma ioport  Timer8_FUNC_REG:    0x130                  //Function register
BYTE            Timer8_FUNC_REG;
#pragma ioport  Timer8_INPUT_REG:   0x131                  //Input register
BYTE            Timer8_INPUT_REG;
#pragma ioport  Timer8_OUTPUT_REG:  0x132                  //Output register
